...
void cal_eb2(double *eb, double *ef_tr, int n1, int n2, int crystal1, int crystal2, double *ef_atoms, int n_crystal_type, double eb0, int natoms_c) {
...
//        printf("ef_tr[%d] = %f\n",i,*(ef_tr+i));
    eb21 = identify_tst(ef_tr,len_ef_n2,eb0);
...
//        printf("ef_tr[%d] = %f\n",i,*(ef_tr+i));
    eb12 = identify_tst(ef_tr,len_ef_n1,eb0);
...
//                printf("ef_tr[%d] = %f\n",i,*(ef_tr+i));
            eb12 = identify_tst(ef_tr,len_ef_n1+len_ef_n2-1,eb0);
            ...
            *(ef_tr + len_ef_n1+len_ef_n2-2) = *(ef_atoms + n_crystal_type*(n1+n2-1) + ii);
            //            for (i=0;i<len_ef_n1+len_ef_n2-1;i++)
            //                printf("ef_tr[%d] = %f\n",i,*(ef_tr+i));
            eb21 = identify_tst(ef_tr,len_ef_n1+len_ef_n2-1,eb0);
